...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "A ligar à rede do Remora..."),
        ...
        ("install_tip", "Devido ao UAC, o Remora não funciona correctamente em alguns casos. Para evitar o UAC, por favor clique no botão abaixo para instalar o Remora no sistema."),
        ("Click to upgrade", "Clique para atualizar"),
        ("Configure", "Configurar"),
        ("config_acc", "Para controlar o seu Ambiente de Trabalho remotamente, é preciso conceder ao Remora permissões de \"Acessibilidade\"."),
        ("config_screen", "Para aceder ao seu Ambiente de Trabalho remotamente, é preciso conceder ao Remora permissões de \"Gravar o Ecrã\"."),
        ...
        ("android_input_permission_tip1", "Para que um dispositivo remoto controle o seu dispositivo Android via rato ou toque, é necessário permitir que o Remora use o serviço \"Acessibilidade\"."),
        ("android_input_permission_tip2", "Por favor vá para a próxima página de configuração do sistema, encontre e entre [Serviços Instalados], ACTIVE o serviço [Remora Input]."),
        ...
        ("Language", "Linguagem"),
        ("Keep Remora background service", "Manter o serviço Remora em funcionamento"),
        ("Ignore Battery Optimizations", "Ignorar optimizações de Bateria"),
        ("android_open_battery_optimizations_tip", "Se pretender desativar esta funcionalidade, aceda à próxima página de definições da aplicação Remora, encontre e abra [Bateria], e desmarque [Sem restrições]"),
        ...
        ("config_input", "Para controlar o ambiente de trabalho remoto com o teclado, é necessário conceder ao Remora as permissões de \"Monitorização de Entrada\"."),
        ("config_microphone", "Para falar à distância, é necessário conceder ao Remora as permissões de \"Gravar Áudio\"."),
        ...
        ("still_click_uac_tip", "Continua a exigir que o utilizador remoto clique em OK na janela do UAC do Remora em execução."),
        ...
        ("verify_Remora_password_tip", "Verificar palavra-passe do Remora"),
        ...
        ("scam_text1", "Se estiver ao telefone com alguém que NÃO conhece NEM em quem confia e que lhe pediu para usar o Remora e iniciar o serviço, não prossiga e desligue imediatamente."),
        ...
        ("upgrade_Remora_server_pro_to_{}_tip", "Atualize o Remora Server Pro para a versão {} ou mais recente!"),
        ...
        ("selinux_tip", "O SELinux está ativado no seu dispositivo, o que poderá impedir o Remora de funcionar corretamente como lado controlado."),
        ...
        ("powered_by_me", "Disponibilizado pelo Remora"),
        ...
        ("allow-only-conn-window-open-tip", "Permitir a ligação apenas se a janela do Remora estiver aberta"),
        ...
        ("floating_window_tip", "Ajuda a manter o serviço em segundo plano do Remora"),
        ...
        ("upgrade_remote_Remora_client_to_{}_tip", "Atualize o cliente Remora para a versão {} ou mais recente no lado remoto!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Por predefinição, o Remora verifica o certificado do servidor para os protocolos que usam TLS.\nCom esta opção ativada, o Remora recorrerá a ignorar a etapa de verificação e prosseguir em caso de falha de verificação."),
        ("Disable UDP", "Desativar UDP"),
        ("disable-udp-tip", "Controla se deve ser usado apenas TCP.\nQuando esta opção está ativada, o Remora deixa de usar a UDP 21116, sendo usada a TCP 21116 em vez dela."),
        ("server-oss-not-support-tip", "NOTA: o Remora server OSS não inclui esta funcionalidade."),
        ...
        ("Remora cannot reach the desktop session on the remote device, check that a desktop session is running and that Remora can use it", "O Remora não consegue aceder à sessão de ambiente de trabalho no dispositivo remoto, verifique se existe uma sessão ativa e se o Remora a pode usar"),
        ...
        ("Remora could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "O Remora não conseguiu obter um ecrã utilizável do XDG Desktop Portal, a biblioteca PipeWire pode ser demasiado antiga"),
        ("Remora could not load a GStreamer component needed for screen capture ({})", "O Remora não conseguiu carregar um componente do GStreamer necessário para capturar o ecrã ({})"),
