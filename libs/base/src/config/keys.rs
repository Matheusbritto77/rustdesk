...
pub const OPTION_PRIVACY_MODE_BG_COLOR: &str = "privacy_mode_bg_color";
pub const OPTION_PRIVACY_MODE_LOGO_PATH: &str = "privacy_mode_logo_path";
pub const OPTION_PRIVACY_MODE_CUSTOM_MESSAGE: &str = "privacy_mode_custom_message";
